/**
 * Centralized logging for MCP Tool Search operations.
 * Provides structured, contextual logs with levels.
 * ALL output goes to stderr to avoid polluting stdout (MCP JSON-RPC).
 */
...
class Logger {
  ...
  private emit(level: LogLevel, message: string, context?: LogContext, error?: Error): void {
    ...
    // Default console output — ALL to stderr
